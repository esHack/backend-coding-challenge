...
app.controller("ctrlExpenses", ["$rootScope", "$scope", "Restangular", "$http", function ExpensesCtrl($rootScope, $scope, $Restangular, $http) {
	// Update the headings
	...
	//added by eswar for VAT calculation
	$scope.change = function() {
       $scope.newExpense.vat=$scope.newExpense.amount/20;
      };

	var loadExpenses = function() {
		
		// Retrieve a list of expenses via REST  modified by eswar
		$Restangular.one("RestJerseyM/rest/json/alchemy/get").getList().then(function(expenses) {
	...
	$scope.saveExpense = function() {
		...
		if ($scope.expensesform.$valid) {
			// Post the expense via REST modified by eswar 
			
			 $Restangular.one("RestJerseyM/rest/json/alchemy/post").post(null, $scope.newExpense).then(function() {}, function() {
			  loadExpenses();
			 });
